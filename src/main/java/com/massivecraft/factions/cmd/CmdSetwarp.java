...
public class CmdSetwarp extends FCommand
{
	...
	public void perform()
	{
		...
		fme.msg("<i>You just set the warp for your faction. It cost your faction %s power for each player and will cost %s power each time you use it.",
				Conf.warpsPowerCostPerPlayerToSet, Conf.warpsPowerCostToUse);
