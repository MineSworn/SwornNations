...
public class CmdSetoutpost extends FCommand
{
	...
	public void perform()
	{
		...
		{
			if (Permission.OUTPOST_SET_ANY.has(sender, true)) return;
		}
		...
		if ( ! payForCommand(Conf.ecnCostSetoutpost, "to set the faction outpost", "for setting the faction outpost")) return;
