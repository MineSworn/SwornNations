...
public enum Permission
{
	...
	public final boolean has(CommandSender sender)
	{
		return has(sender, false);
	}

	public final boolean has(CommandSender sender, boolean informSenderIfNot)
	{
		return SwornNations.get().perm.has(sender, node, informSenderIfNot);
	}
}
